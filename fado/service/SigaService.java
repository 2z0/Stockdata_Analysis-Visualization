...
public class SigaService {
    ...
    public List<CompanySiga> getSiga (Long siga){return repo.findBySigaGreaterThan(siga);}
    public List<CompanySiga> getPrice (Long price, Long siga){return repo.findByPriceLessThanAndSigaIsGreaterThan(price, siga);}
}
